                ...
                >
                    <div className='grid md:grid-cols-2 grid-cols-1 gap-6 mt-6 p-4 font-urbanist'>
                        ...
                        <div className='bg-[#29164C3B] py-5 px-6 rounded-3xl text-white'>
                            ...
                            <a target='_blank' href='https://api.whatsapp.com/send/?phone=+917259191786&text=can%20you%20help%20me%20with...&type=phone_number&app_absent=0' className='flex justify-center items-center hover:text-brand  w-full py-4 bg-transparent border-2 text-brand border-brand rounded-[30px] font-semibold text-lg'>Chat Now</a>
                        </div>
                    </div>
                </Modal>
            </ConfigProvider>
