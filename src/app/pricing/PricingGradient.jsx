...
const PricingGradient = () => {
    ...
    return (
        <>
        <section className='max-w-[1440px] mx-auto md:mt-[90px] lg:mt-[130px] '>
            <div style={{ background: 'linear-gradient(90.00deg, rgb(255, 0, 115),rgb(132, 0, 255) 100%)' }} className=' md:py-[88px] py-[127px] md:px-[40px] relative px-6'>
                <div className='relative z-10'>
                    <h2 className='font-afacad text-center font-bold  lg:text-8xl md:text-[56px] md:leading-[74px] text-5xl '>Ready to bring your ideas to life? Schedule a call with us today!</h2>
                    <p className='text-center max-w-[600px] mx-auto md:mt-10 mt-5'> Our team is here to help you succeed. Let&apos;s work together to achieve your goals and elevate your brand to new heights.</p>
